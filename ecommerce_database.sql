...
-- Junction table: an order can contain multiple products (many-to-many)
...
-- ============================================
-- STEP 3: ANALYSIS QUERIES (Product Analyst style)
-- ============================================

-- 1. Total revenue generated (only Delivered orders)
...
-- 4. Customers with the highest total spend
...
-- 7. Products low on stock (below 40 units) - inventory alert
